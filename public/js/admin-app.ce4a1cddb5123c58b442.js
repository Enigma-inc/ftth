...
exports.default = {
  ...
  methods: {
    ...
    submitPersonalDetails: function submitPersonalDetails(scope) {
      ...
      axios.post("./application/" + this.applicationMeta.applicationId + "/personal-details/" + this.applicationMeta.personalDetailsId, this.basicDetails).then(function (res) {
        ...
        _this2.applicationMeta.personalDetailsId = res.data.basicDetails.id;
    ...
    getPackagesFromServer: function getPackagesFromServer() {
      ...
      axios.get("/packages?type=").then(function (resp) {
        _this3.packageOptions = resp.data;
        _this3.setSelectedPackgeFromParam();
      });
    },
    getFtthLocationsFromServer: function getFtthLocationsFromServer() {
      ...
      axios.get("/api/ftth-locations").then(function (resp) {
        _this4.locations = resp.data;
        _this4.setSelectedLocationFromParam();
      });
    },
    ...
    setSelectedPackgeFromParam: function setSelectedPackgeFromParam() {
      ...
      this.packageOptions.forEach(function (item) {
        var packageParam = _this5.getParameterByName("package");
        if (packageParam) {
          _this5.selectedPackageOption = _this5.packageOptions.filter(function (pkg) {
    ...
    setSelectedLocationFromParam: function setSelectedLocationFromParam() {
      ...
      this.packageOptions.forEach(function (item) {
        var locationParam = _this6.getParameterByName("location");
        if (locationParam) {
          _this6.selectedLocation = _this6.locations.filter(function (loc) {
  ...
  watch: {
    ...
    "basicDetails.serviceType": function basicDetailsServiceType(newValue, oldValue) {
      return this.packageOptions.filter(function (pkg) {
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'C:\\Users\\mokoe\\Documents\\Enigma\\projects\\Econet\\ftth\\node_modules\\process\\browser.js'");
  ...
  return _c('form-wizard', {
    ...
    on: {
      "input": [function($event) {
        ...
        _vm.basicDetails.name = $event.target.value.trim()
      }, function($event) {
    ...
    on: {
      "input": [function($event) {
        if ($event.target.composing) { return; }
        _vm.basicDetails.surname = $event.target.value.trim()
      }, function($event) {
    ...
    on: {
      "input": [function($event) {
        if ($event.target.composing) { return; }
        _vm.basicDetails.phone = $event.target.value.trim()
      }, function($event) {
    ...
    on: {
      "__c": function($event) {
        _vm.basicDetails.serviceType = 'contract'
      }
    }
  }), _vm._v(" "), _c('span', {
    staticClass: "circle"
    ...
    on: {
      "__c": function($event) {
        _vm.basicDetails.serviceType = 'prepaid'
      }
    }
  }), _vm._v(" "), _c('span', {
    staticClass: "circle"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.accountDetails.email = $event.target.value
      }
    }
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.accountDetails.password = $event.target.value
      }
    }
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.accountDetails.repeatPassword = $event.target.value
      }
    }
