...
exports.default = {
    data: function data() {
        return {
            ...
            largeMapZoom: 16,
            selectedLocation: {},
            locations: [{ zoom: 14, name: 'Maseru East, Lakeside, BEDCO & Mohalalitoe', description: ' ', file: 'maseru-east' }, { zoom: 14, name: 'Bus-stop, Cathedral, Sea-point, Stadium Area & Moshoeshoe II', description: ' ', file: 'bus-stop' }, { zoom: 14, name: 'Maseru CBD', description: '', file: 'maseru-cbd' }, { zoom: 14, name: 'Fokothi & the neighbourhood', description: '', file: 'fokothi' }, { zoom: 14, name: 'Maseru West', description: ' All the way through to Partners in Health Lesotho Headquarters', file: 'maseru-west' }, { zoom: 14, name: 'Maseru Industrial', description: '', file: 'maseru-industrial' }, { zoom: 14, name: 'Florida, Hoohlo & Border Post', description: '', file: 'florida' }, { zoom: 14, name: 'Arrival Centre and Prisons Gardens', description: '', file: 'arrival-center' }, { zoom: 14, name: 'Maseru Central, Matekane Estates and Qoatsaneng', description: '', file: 'qoatsaneng' }, { zoom: 14, name: 'Europa & New Parliament', description: '', file: 'new-parliament' }, { zoom: 14, name: 'Happy Villa & Hillsview', description: 'Entire suburb', file: 'hills-view' }, { zoom: 14, name: 'Katlehong, White City, STC & Maseru Mall', description: '', file: 'katlehong' }, { zoom: 14, name: 'Stationary area', description: 'Lesotho Times offices and surrounding suburban homes', file: 'lower-thetsane' }, { zoom: 14, name: 'Lower Thetsane', description: ' From next to the main road through to Mr. Matekane Residential Mansion', file: 'lower-thetsane' }, { zoom: 14, name: 'Thetsane Industrial', description: '', file: 'tsetsane-industrial' }, { zoom: 14, name: 'Thetsane West & Lesia', description: '', file: 'tsetsane-west-lesia' }, { zoom: 14, name: 'Thetsane East', description: '', file: 'thetsane-east' }, { zoom: 14, name: 'Masowe 2', description: '', file: 'maswe-3' }]
        };
    },
    mounted: function mounted() {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    }, [_c('p', [_vm._v("\r\n                  " + _vm._s(location.name) + "\r\n                ")]), _vm._v(" "), (location.file) ? _c('div', {
      staticClass: "btn btn-xs ",
      class: {
        'btn-danger': location == _vm.selectedLocation
      },
      on: {
        "click": function($event) {
          _vm.enlargeMap(location)
        }
      }
    }, [_vm._v("View On Map")]) : _vm._e()]), _vm._v(" "), (location.description) ? _c('small', [_vm._v(_vm._s(location.description))]) : _vm._e()])])
  })), _vm._v(" "), _c('div', {
    staticClass: "col-xs-12 col-sm-6"
  }, [_c('ftth-map')], 1)])
},staticRenderFns: []}
