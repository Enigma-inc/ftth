...
exports.default = {
  ...
  methods: {
    placeApplication: function placeApplication() {
      ...
      axios.post("./place-application", Object.assign({}, this.basicDetails, this.accountDetails)).then(function (response) {
        _this.$noty.success("Application Placed! We shall get back to you.", {
          theme: "metroui",
          layout: "center"
        }).on("onClose", function () {
          window.location.href = "../users/" + response.data.user_id + "/applications";
        });
...
exports.default = {
  ...
  mounted: function mounted() {
    ...
    if (this.packageType) {
      this.location || this.package ? this.link = this.link.concat("&type=" + this.packageType) : this.link = this.link.concat("?type=" + this.packageType);
    }
  }
};
