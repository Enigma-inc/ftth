...
@if (!Auth::guest())
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <!-- Logo -->
             <a class="logo" href="#">
                        <img height="50px" width='100px'  style="margin-right:30px;"  src="{{asset("images/logo.png")}}">
             </a>
                     ...
                     <li class="dropdown user-menu">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        ...
                                        <li>
                                        <a style="color: black;" href="{!! route('users.editpassword', [Auth::user()->id]) !!}">
        ...
        <footer class="main-footer" style="max-height: 100px;text-align: center">
            <strong>Copyright © {{date("Y")}} <a  href="">ECONET-FTTH</a>.</strong> All rights reserved.  
        </footer>
