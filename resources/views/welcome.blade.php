        ...
        <div class="navbar-header">
            ...
            <a href="http://www.creative-tim.com">
                <div class="logo-container">
                    <div class="logo">
                        <img src="{{url('/images/logo.png')}}" alt="Econet Logo" rel="tooltip" title="Econet FTTH - Fiber To The Home" data-placement="bottom" data-html="true">
                    </div>
                   <!-- <div class="brand">
                        ECONET - FTTH
                    </div>-->
...
<div class="wrapper">
    <div class="header header-filter" style="background-image: url('{{url('images/bg.jpg')}}');">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="brand">
                        ...
                        <button class="btn btn-info btn-round">Request FTTH In Your Area<div class="ripple-container"></div></button>
                    </div>
                </div>
            </div>
